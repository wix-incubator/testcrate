...
import type { BuildController, StoredItemController } from '@core/controllers';
...
describe('StoredItemController integration', () => {
  ...
  test('putStoredItem creates item and updates build.itemIds', async () => {
    ...
    expect(build?.itemIds).toEqual([req.itemId]);
  });

  test('patchStoredItem updates in-place and preserves type', async () => {
    const s = await seedBuild();
    const itemId = '00000000-0000-0000-0000-000000000011';
    await controller.putStoredItem({ projectId: s.projectId, buildId: s.buildId, itemId, payload: { id: itemId, projectId: s.projectId, buildId: s.buildId, type: 'allure-result', data: { uuid: itemId, historyId: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', name: 'n', fullName: 'f', start: 1, stop: 2, stage: 'finished', status: 'passed' } } });
  ...
  test('patchStoredItem throws when missing or type mismatched', async () => {
    ...
    await controller.putStoredItem({ projectId: s.projectId, buildId: s.buildId, itemId, payload: { id: itemId, projectId: s.projectId, buildId: s.buildId, type: 'allure-container', data: { uuid: itemId, children: [] } } });
  ...
  test('deleteStoredItem removes item and updates build.itemIds; returns true/false', async () => {
    const s = await seedBuild();
  ...
  test('listStoredItems filters by project/build', async () => {
    ...
    await controller.putStoredItem({ projectId: s.projectId, buildId: s.buildId, itemId: '00000000-0000-0000-0000-000000000021', payload: { id: '00000000-0000-0000-0000-000000000021', projectId: s.projectId, buildId: s.buildId, type: 'allure-container', data: { uuid: '00000000-0000-0000-0000-000000000021', children: [] } } });
    await controller.putStoredItem({ projectId: s2.projectId, buildId: s2.buildId, itemId: '00000000-0000-0000-0000-000000000022', payload: { id: '00000000-0000-0000-0000-000000000022', projectId: s2.projectId, buildId: s2.buildId, type: 'allure-container', data: { uuid: '00000000-0000-0000-0000-000000000022', children: [] } } });
    await controller.putStoredItem({ projectId: s3.projectId, buildId: s3.buildId, itemId: '00000000-0000-0000-0000-000000000023', payload: { id: '00000000-0000-0000-0000-000000000023', projectId: s3.projectId, buildId: s3.buildId, type: 'allure-container', data: { uuid: '00000000-0000-0000-0000-000000000023', children: [] } } });
