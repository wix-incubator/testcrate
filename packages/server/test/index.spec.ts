...
const doFetch: typeof SELF.fetch = async (url, options) => {
...
describe("TestCrate server", () => {
  it("responds with Hello World! (integration style)", async () => {
    const response = await doFetch(
      "https://example.com/api/private/migrations/status",
    );
  ...
  const steps: Step[] = [
    {
      method: "PUT",
      path: "/api/v1/projects/test-project",
      payload: { name: "Silly Project", description: "🤪" },
    },
    {
      method: "PATCH",
      path: "/api/v1/projects/test-project",
      payload: { name: "Updated Silly Project" },
    },
    { method: "GET", path: "/api/v1/projects", payload: null },

    {
      method: "PUT",
      path: "/api/v1/projects/test-project/builds/123",
      payload: {
        name: "Silly Build",
        stage: "running",
        historyId:
    ...
    {
      method: "GET",
      path: "/api/v1/projects/test-project/builds",
      payload: null,
    },

    {
      method: "PUT",
      path: "/api/v1/projects/test-project/builds/123/items/789e0123-e89b-12d3-a456-426614174002",
      payload: {
